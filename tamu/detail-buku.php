            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="../logout.php"><i class="fa fa-ban fa-fw pull-right"></i> Log In</a>
                        </li>
                    </ul>
                    </li>
                    </ul>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <a href="../login.html" class="btn btn-sm btn-primary"> Login dahulu untuk membaca <i class="fa fa-book"></i></a>
