                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="genre" type="text" id="genre" class="form-control" autocomplete="off" placeholder="genre" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" name="asal" id="asal" required>
                                                ...
                                                <option value="Koleksi Bukupedia"> Koleksi Bukupedia</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
