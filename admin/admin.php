                            ...
                            <div class="panel-body table-responsive">
                                <div class="box-tools m-b-15">
                                    <form action="admin.php" method="POST">
                                        <div class="input-group">
                                            <input type='text' class="form-control input-sm pull-right" style="width: 150px;" name='qcari' placeholder='Cari berdasarkan Username' required />
                                ...
                                <table id="example" class="table table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <center>Username <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
                                                <center>Password <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
                                                <center>Nama <i class="fa fa-sort"></i></center>
                                            </th>
                                            <th>
